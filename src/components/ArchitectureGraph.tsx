      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-cyan-400">ORCHESTRATOR</span>
          </div>
          <h3 className="font-heading font-bold text-sm">Turborepo</h3>
          <p className="text-xs text-slate-400 mt-1">Monorepo Management</p>
        </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-magenta-400">FRONTEND</span>
          </div>
          <h3 className="font-heading font-bold text-sm">Next.js + TS</h3>
          <p className="text-xs text-slate-400 mt-1">Reactive UI Client</p>
        </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-emerald-400">API LAYER</span>
          </div>
          <h3 className="font-heading font-bold text-sm">tRPC (RPC)</h3>
          <p className="text-xs text-slate-400 mt-1">End-to-End Type Safety</p>
        </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-amber-400">DATABASE</span>
          </div>
          <h3 className="font-heading font-bold text-sm">Drizzle ORM</h3>
          <p className="text-xs text-slate-400 mt-1">SQL Schema Mapping</p>
        </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-violet-400">OPENAPI</span>
          </div>
          <h3 className="font-heading font-bold text-sm">Express + Scalar</h3>
          <p className="text-xs text-slate-400 mt-1">OpenAPI Interactive Docs</p>
        </div>
        ...
        {activeNode === 'turborepo' && (
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-white font-heading">Turborepo Monorepo Architecture</h3>
            </div>
            ...
            <div className="bg-slate-950 p-4 rounded-xl font-mono text-xs text-cyan-300 border border-slate-800 space-y-1">
              <div>// turbo.json</div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-white font-heading">tRPC RPC Router (No REST Overhead)</h3>
              </div>
              <button onClick={testTrpcCall} className="btn-primary text-xs py-1.5 px-3">
            ...
            <div className="bg-slate-950 p-4 rounded-xl font-mono text-xs text-emerald-300 border border-slate-800 space-y-2">
              ...
              {trpcQueryStatus === 'success' && (
                <div className="p-2 rounded bg-emerald-950/60 border border-emerald-500/40 text-emerald-400 flex items-center gap-2">
                  ...
                  Response: &#123;&quot;result&quot;:&#123;&quot;data&quot;:&#123;&quot;board&quot;:&quot;ESP32&quot;,&quot;temp&quot;:24.5&#125;&#125;&#125; [Type Verified]
                </div>
              )}
            </div>
          </div>
        ...
        {activeNode === 'drizzle' && (
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-white font-heading">Drizzle ORM Lightweight SQL Models</h3>
            </div>
            <p className="text-sm text-slate-300 leading-relaxed">
            ...
            <div className="bg-slate-950 p-4 rounded-xl font-mono text-xs text-amber-300 border border-slate-800 space-y-1">
        ...
        {activeNode === 'scalar' && (
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-white font-heading">Express Adapter & Scalar OpenAPI Docs</h3>
            </div>
            <p className="text-sm text-slate-300 leading-relaxed">
            ...
            <div className="bg-slate-950 p-4 rounded-xl font-mono text-xs text-violet-300 border border-slate-800">
